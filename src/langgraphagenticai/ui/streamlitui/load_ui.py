    ...
    def load_streamlit_ui(self, session_id=None):
        ...
        with st.sidebar:
            ...
            self.user_controls["selected_llm"] = st.selectbox(
                "Select LLM", llm_options, key=f"llm_selectbox_{session_id}"
            )
            ...
            if self.user_controls["selected_llm"] == "Groq":
                ...
                if not self.user_controls["GROQ_API_KEY"]:
                    st.warning(
                        "Please enter your Groq API key to proceed. Don't have one? Visit https://console.groq.com/ to get started."
                    )

            # Usecase selection
            self.user_controls["selected_usecase"] = st.selectbox(
                "Select Use Cases", usecase_options, key="usecase_selectbox"
            )
            ...
            if self.user_controls["selected_usecase"] in [
                ...
                if not self.user_controls["TAVILY_API_KEY"]:
                    st.warning(
                        "Please enter your Tavily API key to proceed. Don't have one? Visit https://tavily.com/ to get started."
                    )
