...
class AINewsNode:
    """
    A node for AI news that uses Tavily to fetch the latest AI news.
    """
    ...
    def __init__(self, llm):
        ...
        # This is used to capture various steps in this file so that
        # later can be used for steps shown
        self.state = {}

    def fetch_news(self, state: dict) -> dict:
        """
        Fetch the latest AI news based on the specified frequency.
